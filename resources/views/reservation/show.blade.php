...
<div class="row justify-content-center">
    <div class="col-lg-8 col-sm-12">
        ...
        <div class="row ">
            ...
            <div class="col d-flex justify-content-center">
                <button class="btn btn-danger" type="button">Rechazar solicitud</button>
            </div>
            <div class="col d-flex justify-content-center">
                <button class="btn btn-primary" type="button">Aprobar solicitud</button>
            </div>
            <div class="col d-flex justify-content-center">
                <button class="btn btn-success" type="button">Correo a seguridad</button>
            </div>
        </div>
    </div>
</div>
